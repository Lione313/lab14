...
import { showSeriesService, updateSeriesService } from "../../services/SerieService";
...
function SerieEditFormPage(){
    ...
    const setDataForm = async () => {
        const resp = await showSeriesService(id);
        setData(resp.data);
    }
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await updateSeriesService(data.id, data);
            ...
            <div className="container mt-3">
                ...
                <form onSubmit={handleSubmit} className="row">
                    ...
                    <div className="col-md-8">
                        ...
                        <div className="mb-3">
                            <button className="btn btn-primary me-2">Actualizar Serie</button> 
